...
var body = document.getElementsByTagName('body')[0]; // Resize navbar color depends on configurator active type of sidenav

var referenceButtons = document.querySelector('[data-class]'); // Deactivate sidenav type buttons on resize and small screens
