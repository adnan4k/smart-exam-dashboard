                ...
                <div class="flex flex-wrap border shadow rounded-lg p-3 dark:bg-gray-600">
                    ...
                    <div class="flex flex-col gap-2 w-full border-gray-400">
                        ...
                        <div>
                            ...
                            @error('yearGroupId') <span class="text-red-500">{{ $message }}</span> @enderror
                        </div>
                        ...
                        <div>
                            ...
                            @error('questionText') <span class="text-red-500">{{ $message }}</span> @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                class="w-full py-3 border border-slate-200 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow dark:bg-gray-600 dark:text-gray-100">
                            @error('questionImage') <span class="text-red-500">{{ $message }}</span> @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                class="w-full py-3 border border-slate-200 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow dark:bg-gray-600 dark:text-gray-100">
                            @error('answerText') <span class="text-red-500">{{ $message }}</span> @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                class="w-full py-3 border border-slate-200 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow dark:bg-gray-600 dark:text-gray-100"></textarea>
                            @error('explanation') <span class="text-red-500">{{ $message }}</span> @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                class="w-full py-3 border border-slate-200 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow dark:bg-gray-600 dark:text-gray-100">
                            @error('explanationImage') <span class="text-red-500">{{ $message }}</span> @enderror
                        </div>
