                    ...
                    <div class="flex flex-col gap-2 w-full border-gray-400">
                        ...
                        <div class="flex items-center p-4 bg-gray-50 rounded-lg dark:bg-gray-700">
                            ...
                            <div class="ml-2 text-sm">
                                <label for="isSample" class="font-medium text-gray-900 dark:text-gray-300">Mark as Sample Subject</label>
                                <p class="text-xs text-gray-500 dark:text-gray-400">All questions in this subject will be available in the sample questions section</p>
                            </div>
                            @error('isSample')
